...
<body>
    ...
    <script>
        ...
        */
        ...
        // Función para generar el HTML del presupuesto con el diseño de Canva
        ...
        // Nueva función para generar presupuesto mejorada
        function generateRevestikaQuote() {
            try {
                ...
                // Ocultar la sección de presupuesto generado anterior
                const generatedQuote = document.getElementById('generatedQuote');
                if (generatedQuote) {
                    generatedQuote.style.display = 'none';
                }
        ...
        // Función para descargar PDF directamente (alternativa)
        ...
        const originalDownloadQuotePDF = downloadQuotePDF;

        // Nuevas funciones que reemplazan las originales
        function generateQuote() {
            generateRevestikaQuote();
        }

        function downloadQuotePDF() {
            downloadRevestikaPDF();
        }

        console.log('🎨 NUEVO SISTEMA DE PRESUPUESTOS REVESTIKA IMPLEMENTADO');
        console.log('✅ Diseño idéntico al template de Canva');
        console.log('✅ Numeración automática de presupuestos');
        console.log('✅ Vista previa en nueva ventana');
        console.log('✅ Función de impresión mejorada');
        console.log('✅ Compatibilidad con descarga PDF');
    </script>
</body>
</html>